...
#ifdef CONFIG_DYNAMIC_THERMAL  
static BLOCKING_NOTIFIER_HEAD(apk_state_notifier);
static struct pm_qos_constraints apk_state_constraints = {
        .list = PLIST_HEAD_INIT(apk_state_constraints.list),
        .target_value = PM_QOS_APK_STATE_DEFAULT_VALUE,
        .default_value = PM_QOS_APK_STATE_DEFAULT_VALUE,
        .type = PM_QOS_MAX,
        .notifiers = &apk_state_notifier,
};
static struct pm_qos_object apk_state_pm_qos = {
        .constraints = &apk_state_constraints,
        .name = "apk_state",
};
#endif
// cuiyu add 20151016  for chg_cur_max
static BLOCKING_NOTIFIER_HEAD(chg_cur_max_notifier);
static struct pm_qos_constraints chg_cur_max_constraints = {
        .list = PLIST_HEAD_INIT(chg_cur_max_constraints.list),
        .target_value = PM_QOS_CHG_CUR_MAX_DEFAULT_VALUE ,
        .default_value = PM_QOS_CHG_CUR_MAX_DEFAULT_VALUE ,
        .type = PM_QOS_MIN,
        .notifiers = &chg_cur_max_notifier,
};
static struct pm_qos_object chg_cur_max_pm_qos = {
        .constraints = &chg_cur_max_constraints,
        .name = "chg_cur_max",
};
// cuiyu add 20151016  for chg_cur_min
static BLOCKING_NOTIFIER_HEAD(chg_cur_min_notifier);
static struct pm_qos_constraints chg_cur_min_constraints = {
        .list = PLIST_HEAD_INIT(chg_cur_min_constraints.list),
        .target_value = PM_QOS_CHG_CUR_MIN_DEFAULT_VALUE ,
        .default_value = PM_QOS_CHG_CUR_MIN_DEFAULT_VALUE ,
        .type = PM_QOS_MAX,
        .notifiers = &chg_cur_min_notifier,
};
static struct pm_qos_object chg_cur_min_pm_qos = {
        .constraints = &chg_cur_min_constraints,
        .name = "chg_cur_min",
};

//cuizhouhua added for start app performance priority,set 1 to force /dev/cpu_freq_min can bigger than /dev/cpu_freq_max
static BLOCKING_NOTIFIER_HEAD(app_start_pri_notifier);
static struct pm_qos_constraints app_start_pri_constraints = {
	.list = PLIST_HEAD_INIT(app_start_pri_constraints.list),
	.target_value = PM_QOS_APP_START_PRI_DEFAULT_VALUE,
	.default_value = PM_QOS_APP_START_PRI_DEFAULT_VALUE,
	.type = PM_QOS_MAX,
	.notifiers = &app_start_pri_notifier,
};
static struct pm_qos_object app_start_pri_pm_qos = {
	.constraints = &app_start_pri_constraints,
	.name = "app_start_pri",
};
...
static struct pm_qos_object *pm_qos_array[] = {
	...
	&app_start_pri_pm_qos //added for start app priority
#endif
};
