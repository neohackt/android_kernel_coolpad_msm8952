	...
	const char *buf, size_t count)
{
	...
	//pwm_cfg->pwm_period_us = pwm_us;//connect pmic,use default value,modified for led blink by fengdongjie
...
bad_lpg_params:
	//pwm_cfg->use_blink = false;//connect pmic,midified by fengdongjie
