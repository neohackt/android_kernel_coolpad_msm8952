...
struct panel_reg_check {
	char reg;
	char ret_num;
	char *reg_content;
};

struct dsi_panel_alive_reg {
	int reg_num;
	struct panel_reg_check *check_regs;
};
#endif
...
struct mdss_dsi_ctrl_pdata {
	...
	int disp_te_gpio;
#ifdef CONFIG_YL_LCD_DISPLAY_COMMON
	int disp_vddi_enable_gpio;//added by lvle for lcd 1.8v enable
	int disp_vci_enable_gpio;//added by lvle for lcd 3.3v enable
#endif
	int rst_gpio;
	int disp_en_gpio;
	int bklt_en_gpio;
	...
	//ce-end
	struct dsi_panel_cmds hx8394a_cmds;//hx8394a-esd
	struct dsi_panel_alive_reg panel_alive_reg;
#endif
...
//gongrui@yulong.com add start 8-12
#ifdef CONFIG_YL_LCD_DISPLAY_COMMON
	bool avdd_avee_enabled;
	bool resetdown_after_avdd_avee_enabled;
        u32 avdd;
        u32 avee;
//gongrui@yulong.com end end 8-12
#endif
...
#ifdef CONFIG_YL_LCD_DISPLAY_COMMON
int mdss_dsi_panel_vddi_enable(struct mdss_panel_data *pdata, int enable);//added by lvle for lcd 1.8v enable
