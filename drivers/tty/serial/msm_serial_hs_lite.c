...
//Aliang add for close serial hsl
#ifdef CONFIG_YL_CLOSE_SERIAL_HSL
	static char qcom_hsl_enable = 0;
	static int __init setup_msm_serial_hsl_enable( char *line )
	{
		printk("setup_msm_serial_hsl_enable\n");
		qcom_hsl_enable = 1;
		return 1;
	}
	__setup("hsl_enable",setup_msm_serial_hsl_enable);
#endif
//Aliang
...
//Aliang add
#ifdef CONFIG_YL_CLOSE_SERIAL_HSL
	if(qcom_hsl_enable == 0)
	{
        printk("YLLOG:qcom_hsl_enable: %d\n", qcom_hsl_enable);
        return -1;
	}
#endif
//Aliang
