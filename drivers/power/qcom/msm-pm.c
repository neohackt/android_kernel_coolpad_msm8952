...
extern int gpiolib_show_yl(int force);
extern int clock_show_yl(int force);
extern int regulatorstatusprint_yl(int force);
#ifdef CONFIG_YL_PM_DEBUG_PINCTRL
extern int msm_pconf_all_pins(bool to_suspend);
extern bool need_dump;
#endif
#endif
