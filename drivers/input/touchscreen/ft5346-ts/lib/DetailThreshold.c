...
void malloc_struct_DetailThreshold(void)
{
    ...
    g_stCfg_MCap_DetailThreshold.SCapCbTest_ON_Max = (short (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(int), GFP_ATOMIC);
    g_stCfg_MCap_DetailThreshold.SCapCbTest_ON_Min = (short (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(int), GFP_ATOMIC);
    g_stCfg_MCap_DetailThreshold.SCapCbTest_OFF_Max = (short (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(int), GFP_ATOMIC);
    g_stCfg_MCap_DetailThreshold.SCapCbTest_OFF_Min = (short (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(int), GFP_ATOMIC);
