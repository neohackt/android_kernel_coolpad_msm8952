...
#define	FTS_BUFFER_I_FILE_1	"i_file1/coolpad_A9_0xE9_001_V04_D02_20160415_app.i"
...
static int fts_flash_compare_chip_id(unsigned char chip_id, unsigned char chip_id2)
{
	...
	if(fts_ic_table_need_chip_id2(chip_id) < 0)/*不需要chip_id2*/
	{
