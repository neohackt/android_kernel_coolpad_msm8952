...
*******************************************************************************/
#define FOCALTECH_FLASH_FT8716_INFO  "File Version of  focaltech_flash_ft8716.c:  V1.0.0 2016-03-21"
...
u8 reg_val[4] = {0};
	...
	{
		//如果软件复位不成功，采用硬件复位
		if(0 != fts_upgrade_hardware_reset(200, 0x87, 0x16))
			return -EIO;
	}
