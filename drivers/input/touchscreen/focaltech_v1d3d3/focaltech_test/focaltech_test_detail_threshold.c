...
int malloc_struct_DetailThreshold(void)
{
	...
	g_stCfg_MCap_DetailThreshold.SCapCbTest_ON_Max = (short (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(short), GFP_ATOMIC); 
	if(NULL == g_stCfg_MCap_DetailThreshold.SCapCbTest_ON_Max) goto ERR;
	g_stCfg_MCap_DetailThreshold.SCapCbTest_ON_Min = (short (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(short), GFP_ATOMIC); 
	if(NULL == g_stCfg_MCap_DetailThreshold.SCapCbTest_ON_Min) goto ERR;
	g_stCfg_MCap_DetailThreshold.SCapCbTest_OFF_Max = (short (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(short), GFP_ATOMIC); 
	if(NULL == g_stCfg_MCap_DetailThreshold.SCapCbTest_OFF_Max) goto ERR;
	g_stCfg_MCap_DetailThreshold.SCapCbTest_OFF_Min = (short (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(short), GFP_ATOMIC); 
	...
	ERR:
	FTS_TEST_DBG("kmalloc memory failed in function.");
	return -1;		
}
void free_struct_DetailThreshold(void)
{
	...
	if(NULL != g_stCfg_MCap_DetailThreshold.NoistTest_Coefficient)
		kfree(g_stCfg_MCap_DetailThreshold.NoistTest_Coefficient);	
}
