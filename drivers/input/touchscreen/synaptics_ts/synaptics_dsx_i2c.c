...
static int parse_dt(struct device *dev, struct synaptics_dsx_board_data *bdata)
{
    ...
    //shihaobin@yulong.com modify for resolve some call trace warning in log 20151201 begin
    ...
    //} else {
        //bdata->reset_delay_ms = 0;
    //}
    //shihaobin@yulong.com modify for resolve some call trace warning in log 20151201 end
...
{
	int retval;
printk(KERN_ERR"yl_syna_debug %s  into I2C probe succeed\n",__func__);
...
printk(KERN_ERR"yl_syna_debug %s  into I2C probe succeed  end\n",__func__);
	return 0;
}
...
{
	int retal;
    retal=i2c_add_driver(&synaptics_rmi4_i2c_driver);
printk(KERN_ERR"yl_syna_debug :retal=%d \n",retal);
    return retal;
}
