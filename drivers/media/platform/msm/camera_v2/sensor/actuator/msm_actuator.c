...
static int32_t msm_actuator_park_lens(struct msm_actuator_ctrl_t *a_ctrl)
{
	...
	while (next_lens_pos > 60) {
//    pr_err("wbll next_lens_pos= %d,a_ctrl->park_lens.max_step=%d,a_ctrl->initial_code=%d\n",next_lens_pos,a_ctrl->park_lens.max_step,a_ctrl->initial_code);
