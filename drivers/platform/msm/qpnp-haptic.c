...
#define QPNP_HAP_VMAX_MIN_MV		696
#define QPNP_HAP_VMAX_STEP		116
#ifdef CONFIG_BOARD_CP3600I
#define QPNP_HAP_VMAX_MAX_MV		3600
#else
#define QPNP_HAP_VMAX_MAX_MV		2200
#endif
...
static int qpnp_hap_vmax_config(struct qpnp_hap *hap)
{
	...
	temp = hap->vmax_mv / QPNP_HAP_VMAX_STEP;
...
#ifdef CONFIG_YL_SET_VOLTAGE_LEVEL
 // xuqianqiao 20150702 remove auto resonance parameters
	if (0) {
#else
	if (hap->act_type == QPNP_HAP_LRA) {
#endif
