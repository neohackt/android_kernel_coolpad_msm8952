...
struct msm8x16_wcd_priv {
	...
	int (*codec_spk_ext_pa_cb)(struct snd_soc_codec *codec, int enable);
        int (*codec_spk_boost_ctl_cb)(struct snd_soc_codec *codec, int enable);
...
extern void msm8x16_wcd_spk_boost_ctl_cb(int (*codec_spk_boost_ctl_cb)(struct snd_soc_codec *codec,
		int enable), struct snd_soc_codec *codec);

/* Added by Yulong for boot optimization, fengdongjie */
extern bool is_8x16_wcd_codec_registered(void);
/* Add end */
#endif
