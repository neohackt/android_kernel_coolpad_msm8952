				...
				struct snd_ctl_elem_value *ucontrol)
{
	...
	case 10:
		...
		break;
//func:set skype echo reference
//date:7/28/2016
//name:sunyonggang
#ifdef CONFIG_SET_SKYPE_SPK_ECHO_REFERENCE
        case 11:
...
/*yulong add for FM speaker use quin Mi2s,by lijiakan 2016.3.21 ---start*/
...
/*yulong add for FM speaker use quin Mi2s,by lijiakan 2016.3.21 ---end*/
