...
enum pon_restart_reason {
	PON_RESTART_REASON_FASTBOOT      	= 0x01,
	PON_RESTART_REASON_NORMAL_REBOOT    = 0x02,
	PON_RESTART_REASON_RECOVERY,
	PON_RESTART_REASON_KEREXCEP_REBOOT,
	PON_RESTART_REASON_SYSEXCEP_REBOOT,
	PON_RESTART_REASON_SILENCE_REBOOT,
	PON_RESTART_REASON_OTA_BY_FORCE,
	PON_RESTART_REASON_LOWMEM,
	PON_RESTART_REASON_RUIMREFRESH,
	PON_RESTART_REASON_LOSTCARD,
	PON_RESTART_REASON_RTC,
	PON_RESTART_REASON_FASTMMI,
	PON_RESTART_REASON_NV_RECOVERY,
	PON_RESTART_REASON_AT_CFUN_RESET,
	PON_RESTART_REASON_CHECK_SCHEDULE,
	PON_RESTART_REASON_SAFE,
	PON_RESTART_REASON_FASTBOOT_REBOOT,
	PON_RESTART_REASON_ACTION,
	PON_RESTART_REASON_NULL_CMD,
	PON_RESTART_REASON_INVALID_REBOOT_MODE
};
#else
enum pon_restart_reason {
