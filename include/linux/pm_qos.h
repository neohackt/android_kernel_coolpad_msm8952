...
#define PM_QOS_APP_START_PRI_DEFAULT_VALUE  0
#define PM_QOS_CHG_CUR_MAX_DEFAULT_VALUE  INT_MAX
#define PM_QOS_CHG_CUR_MIN_DEFAULT_VALUE  0
#ifdef CONFIG_DYNAMIC_THERMAL
#define PM_QOS_APK_STATE_DEFAULT_VALUE  100
#endif
#endif
