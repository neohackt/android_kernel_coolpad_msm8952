...
#include <asm/errno.h>
/*add for yulong playform*/
struct pcb_version{
    unsigned int pcb_id;
	const char *proj_id;
};
extern struct pcb_version __yulong_pl_pcb_version__(void);
#define YL_CURT_PCB_VER (__yulong_pl_pcb_version__()).pcb_id
#define YL_CURT_PROJ_ID (__yulong_pl_pcb_version__()).proj_id
enum {
    YL_PCB_VER_T0=0,
    YL_PCB_VER_T1=1,
    YL_PCB_VER_T2=2,
