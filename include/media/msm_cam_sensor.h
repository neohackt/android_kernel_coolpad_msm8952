...
#define MODULE_TECH_OV8856 (SENSOR_ID_OV8856 << 16 |0x06)
#define MODULE_OFILM_OV8856 (SENSOR_ID_OV8856 << 16 |0x07)
#define MODULE_ZQIAO_OV8856 (SENSOR_ID_OV8856 << 16 |0x08)
...
#define MODULE_QTECH_IMX135 (SENSOR_ID_IMX135 << 16 | 0x06)


#define SENSOR_ID_IMX219 0x0219
#define MODULE_OFILM_IMX219 (SENSOR_ID_IMX219 << 16 | 0x07)
#define MODULE_TECH_IMX219 (SENSOR_ID_IMX219 << 16 | 0x06)

#define SENSOR_ID_HI841 0x0841
#define MODULE_KAIER_HI841 (SENSOR_ID_HI841 << 16 | 0x01)
#define MODULE_BOYI_HI841 (SENSOR_ID_HI841 << 16 | 0x02)
#define MODULE_BOYI_GUANDONG_HI841 (SENSOR_ID_HI841 << 16 | 0x10)
...
#define SENSOR_ID_AR1335 0x0153
#define MODULE_SUNNY_AR1335 (SENSOR_ID_AR1335 << 16 | 0x84)
#define MODULE_OFILM_AR1335 (SENSOR_ID_AR1335 << 16 | 0x42)
